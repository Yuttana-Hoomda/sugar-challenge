...
import SUGAR from '../app/images/SUGARCHALLENGE.svg'
import Substract from '../app/images/Subtract.svg'
export default function GoogleSigin(){
    return (
        ...
        <div className="flex flex-col justify-center items-center gap-2 mt-8">
            <Image src={SUGAR} alt='SUGAR' width={300} height={300} />
        </div>

        <div className="mt-9 justify-center items-center ml-14">
